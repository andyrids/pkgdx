"""Main entry point for pytack pre-commit hooks and CLI."""
...
from pytack import _core, exceptions, standards
...
def command_setup(ctx: _core.CLIContext) -> int:
    ...
    with _setup_progress(ctx.console) as progress:
        ...
        progress.update(task, description="[green]pytack complete")
