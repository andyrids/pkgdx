...
Validate code changes through; existing unit tests, new unit tests (if necessary), Astral
workspace member testing and standard compliance checks.
...
9. Execute consumer package testing against `consumers/testing/` package
