...
context-hierarchy-scope: Feature-scoped - read only when working on the axi CLI (src/pkgdx/axi)
---
...
emits (`tests/test_axi_toon_benchmark.py`, characters vs compact JSON):
